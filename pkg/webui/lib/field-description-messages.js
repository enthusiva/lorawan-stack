...
const m = defineMessages({
  ...
  devEuiAbsence: 'Contact the manufacter or your reseller.',
  ...
  joinEuiAbsence:
    'Contact the manufacter or your reseller. If they can not provide a JoinEUI, and your end device is programmable, it is okay to use `0000000000000000`, but ensure that you use the same JoinEUI in your device as you enter in The Things Stack.',
  ...
  appKeyAbsence:
    'Contact the manufacter or your reseller. If they can not provide an AppKey, and your end device is programmable, it is okay to generate one.',
  ...
  joinServerLocation:
    'Contact your manufacterer or reseller to find out if your end device is pre-provisioned on an external Join Server. If not, you may use the local Join Server, or provision the device on our Global Join Server so that you can transfer it without lock-in.',
  joinServerAbsence:
